...
| [0017](0017-declared-provider-differences.md) | Provider differences: declare serialization, code behavior | Accepted — thinking axes shipped; stencil refresh open (phase 7) | 2026-08-12 |
