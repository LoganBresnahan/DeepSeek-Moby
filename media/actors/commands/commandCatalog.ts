...
export const DEFAULT_COMMANDS: CommandItem[] = [
  ...
  { id: 'moby.manageMcpServers', name: 'MCP Servers', description: 'See server status and turn servers on or off', icon: '🔌', section: 'Settings' },
  { id: 'moby.refreshMcpServers', name: 'Refresh MCP Servers', description: 'Restart configured MCP servers (use after one dies or you install it)', icon: '🔄', section: 'Settings' },
  // Info section
